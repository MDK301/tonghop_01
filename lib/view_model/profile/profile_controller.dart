...
//           .ref('/profileImage/${SessionController().userIdRealtime}');
//
//       // Upload file ảnh
...
//       await ref.child(SessionController().userIdRealtime.toString()).update({
//         'profile': newUrl,
//       });
//
...
//               TextButton(
//                   onPressed: () {
//                     ref.child(SessionController().userIdRealtime.toString()).update({
...
class ProfileController with ChangeNotifier {
  ...
  void uploadImage(BuildContext context) async {
    ...
    try {
      ...
      // // Cập nhật URL mới vào Cloud Firestore
      // FirebaseFirestore.instance
      //     .collection('Users')
      //     .doc(SessionController().userIdRealtime)
