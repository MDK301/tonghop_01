...
class AppColors {
  ...
  static const Color primaryNavBarColor =  Color(0xff69f0ae);
  static const Color primaryActiveNavBarColor =  Color(0xFF388E3C);
  static const Color secondaryActiveNavBarColor =  Color(0xffffffff);
